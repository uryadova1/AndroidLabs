...
class ConverterActivity : ComponentActivity() {
    ...
    private fun convertCurrencies() {
        ...
        if (amount != null && (selectedInCurrency != null && selectedInCurrency != this.getString(R.string.hint_str)) && (selectedOutCurrency != null && selectedOutCurrency != this.getString(R.string.hint_str))) {
